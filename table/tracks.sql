create table web.portfolio.tracks
(
...
create table web.portfolio.track_links
(
...
INSERT INTO web.portfolio.tracks (track_id, track_name, track_name_cn, author_id, release_date, description, description_cn)
VALUES (1, 'Spy 94', '内鬼94', '{1}', '2023-07-19', 'You are kinda sus.', '你很可疑。');
INSERT INTO web.portfolio.tracks (track_id, track_name, track_name_cn, author_id, release_date, description, description_cn)
VALUES (2, 'Resee', '重见天日', '{1}', '2023-11-10', 'Re see the light.', '重新看见光亮。');

INSERT INTO web.portfolio.track_links (link_id, track_id, platform_id, link_url)
VALUES (2, 1, 2, 'wdsd');
INSERT INTO web.portfolio.track_links (link_id, track_id, platform_id, link_url)
